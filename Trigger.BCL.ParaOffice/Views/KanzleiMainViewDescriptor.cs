            ...
            NavigationGroups = new List<NavigationGroupItem>
            {
                ...
                new NavigationGroupItem("Stammdaten", 2)
                {
                    NavigationItems = new List<NavigationItem>
                    {
                        ...
                        new NavigationItem(typeof(AktPerson), "Aktpersonen", 2){ ImageName = "user_add", Visible = ApplicationQuery.CurrentUserIsAdministrator },
                        new NavigationItem(typeof(SB), "Sachbearbeiter", 3){ ImageName = "user_accept", Visible = ApplicationQuery.CurrentUserIsAdministrator },
                        new NavigationItem(typeof(User), "Benutzer", 4) { ImageName = "community_users", Visible = ApplicationQuery.CurrentUserIsAdministrator }
                    }
                }
            };
        }
